...
describe('User Editing', function (): void {
    ...
    // });
    //
    // test('name cannot be longer than 255 characters', function (): void {
    //     $user = User::factory()->create();
    //
    //     livewire(EditUser::class, ['record' => $user->getRouteKey()])
    //         ->fillForm([
    //             'name' => (string) str('a')->repeat(256),
    //         ])
    //         ->call('save')
    //         ->assertHasFormErrors([
    //             'name' => 'max',
    ...
    // });
    //
    // test('email cannot be longer than 255 characters', function (): void {
    //     $domain = '@example.com';
    //     $user = User::factory()->create();
    //
    //     livewire(EditUser::class, ['record' => $user->getRouteKey()])
    //         ->fillForm([
    //             'email' => (string) str('a')->repeat(256 - str($domain)->length())->append($domain),
    //         ])
    //         ->call('save')
    //         ->assertHasFormErrors([
    //             'email' => 'max',
    ...
    // });
    //
    // test('password confirmation is required with password', function (): void {
    //     $user = User::factory()->create();
    //
    //     livewire(EditUser::class, ['record' => $user->getRouteKey()])
    //         ->fillForm([
    ...
    // });
    //
    // test('password confirmation must be the same as the password', function (): void {
    //     $user = User::factory()->create();
    //
    //     livewire(EditUser::class, ['record' => $user->getRouteKey()])
    //         ->fillForm([
    //             'password' => $password = fake()->password(),
    //             'password_confirmation' => str($password)->append(fake()->randomLetter()),
    //         ])
    //         ->call('save')
    //         ->assertHasFormErrors([
